...
\put(85,60){$E$};
\end{tikzpicture}
\caption{Visualizzazione di tutti i siti (in verde) appartenenti all'intorno di Von Neumann di un individuo (in rosso) con relative direzioni (Nord, Sud, Est, Ovest).}
\label{Fig:2}
\end{figure}
...
\end{axis}
\end{tikzpicture}
\caption{Struttura toroidale dell'automa cellulare dovuta alla condizioni al contorno periodiche.}
\label{Fig:3}
\end{figure}
...
\end{tikzpicture}
\caption{Intorni di Moore estesi di raggio 2 in due differenti casi.}
\label{Fig:4}
\end{figure}
