...
\begin{figure}[h!!]
\centering
\includegraphics[width=0.8\linewidth]{Gravitazione/Time_distribution_correlation.pdf}
...
I \textit{fit} dei dati sono stati eseguiti attraverso la tangente iperbolica in Eq.\ref{Eq:12} e hanno portato alla stima dei parametri riportati nella seguente tabella.
...
\begin{figure}[h]
\centering
\includegraphics[width = 1.1\linewidth]{Immagini/poland_magnetization_graph.png}
...
\begin{figure}[h]
\centering
\includegraphics[width = 1.1\linewidth]{Immagini/poland_sim_magnetization_graph.png}
