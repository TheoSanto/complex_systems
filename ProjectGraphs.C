...
void magnetization_graph() {
  ...
  TGraph* graph1 = new TGraph("/home/matteo/root/macros/ProgettoBazzani/sim_data_p=tanh1/magn_data/magn_data_n100_d1.csv", "%lg %lg");
  //graph1->SetTitle("Magnetizzazione per #delta = 2 e c^{in}_{-} = 0.25; t (u.t.a.); M");
  graph1->SetTitle("; t (u.t.a.); M");
  graph1->SetLineColor(kBlue);
  graph1->SetLineWidth(3);
  graph1->GetXaxis()->SetLimits(0,500);
  ...
  leg1->SetFillColor(0);
  leg1->AddEntry(graph1,"Magnetizzazione per #delta = 1"); 

  TGraph* graph2 = new TGraph("/home/matteo/root/macros/ProgettoBazzani/sim_data_p=tanh1/magn_data/magn_data_n100_d2.csv", "%lg %lg");
  //graph2->SetTitle("Evoluzione Temporale della Magnetizzazione per #delta =2; t (u.t.a.); M");
  graph2->SetTitle("; t (u.t.a.); M");
  graph2->SetLineColor(kBlue);
  graph2->SetLineWidth(3);
  graph2->GetXaxis()->SetLimits(0,500);
  ...
  graph2->GetXaxis()->SetTitleOffset(0.7);
  ...
  leg2->SetFillColor(0);
  leg2->AddEntry(graph2,"Magnetizzazione per #delta = 2"); 

  TGraph* graph4 = new TGraph("/home/matteo/root/macros/ProgettoBazzani/sim_data_p=tanh1/magn_data/magn_data_n100_d4.csv", "%lg %lg");
  //graph4->SetTitle("Evoluzione Temporale della Magnetizzazione per #delta =4; t (u.t.a.); M");
  graph4->SetTitle("; t (u.t.a.); M");
  graph4->SetLineColor(kBlue);
  graph4->SetLineWidth(3);
  graph4->GetXaxis()->SetLimits(0,500);
  graph4->GetYaxis()->SetRangeUser(-1.,1.);
  ...
  graph4->GetXaxis()->SetTitleOffset(0.7);
  graph4->GetYaxis()->SetTitleOffset(0.7);
  graph4->GetXaxis()->SetLabelFont(132); 
  graph4->GetXaxis()->SetTitleFont(132); 
  graph4->GetYaxis()->SetLabelFont(132); 
  graph4->GetYaxis()->SetTitleFont(132);

  TLegend* leg4 = new TLegend(.1,.7,.3,.9);
  leg4->SetFillColor(0);
  leg4->AddEntry(graph4,"Magnetizzazione per #delta = 4"); 

  TGraph* graph8 = new TGraph("/home/matteo/root/macros/ProgettoBazzani/sim_data_p=tanh1/magn_data/magn_data_n100_d8.csv", "%lg %lg");
  //graph8->SetTitle("Evoluzione Temporale della Magnetizzazione per #delta =8; t (u.t.a.); M");
  graph8->SetTitle("; t (u.t.a.); M");
  graph8->SetLineColor(kBlue);
  graph8->SetLineWidth(3);
  graph8->GetXaxis()->SetLimits(0,500);
  graph8->GetYaxis()->SetRangeUser(-1.,1.);
  ...
  graph8->GetXaxis()->SetTitleOffset(0.7);
  graph8->GetYaxis()->SetTitleOffset(0.7);
  graph8->GetXaxis()->SetLabelFont(132); 
  graph8->GetXaxis()->SetTitleFont(132); 
  graph8->GetYaxis()->SetLabelFont(132); 
  graph8->GetYaxis()->SetTitleFont(132); 
 
  TLegend* leg8 = new TLegend(.1,.7,.3,.9);
  leg8->SetFillColor(0);
  leg8->AddEntry(graph8,"Magnetizzazione per #delta = 8"); 
...
void decision_time_graph() {
  ...
  ifstream file("/home/matteo/root/macros/ProgettoBazzani/sim_data_p=tanh1/partial_time_data/partial_time_data_n100_d4_v8.csv");
  ...
  graph->Fit("power","R","",1.,40.);  //(110 per delta = 4, 20 per delta = 8) per Normale;  (130 per v=2, 50 per v=4, ) per Visione Parziale
...
//-3.85148   +/-   0.0186302               per v=1;  (expo)
//-0.0193171   +/-   0.000507038
...
void initial_condition_influence_graph() {
  ...
  ifstream file1("/home/matteo/root/macros/ProgettoBazzani/init_data_fixed/init_data_sim500_d4_reds10_fixed.txt");
  while (1) {
    if (!file1.good()) break;
  ...
  ifstream file2("/home/matteo/root/macros/ProgettoBazzani/init_data_fixed/init_data_sim500_d4_reds20_fixed.txt");
  while (1) {
    if (!file2.good()) break;
  ...
  ifstream file3("/home/matteo/root/macros/ProgettoBazzani/init_data_fixed/init_data_sim500_d4_reds30_fixed.txt");
  while (1) {
    if (!file3.good()) break;
  ...
  ifstream file4("/home/matteo/root/macros/ProgettoBazzani/init_data_fixed/init_data_sim500_d4_reds40_fixed.txt");
  while (1) {
    if (!file4.good()) break;
  ...
  ifstream file5("/home/matteo/root/macros/ProgettoBazzani/init_data_fixed/init_data_sim500_d4_reds50_fixed.txt");
  while (1) {
    if (!file5.good()) break;
  ...
  ifstream file6("/home/matteo/root/macros/ProgettoBazzani/init_data_fixed/init_data_sim500_d4_reds60_fixed.txt");
  while (1) {
    if (!file6.good()) break;
  ...
  ifstream file7("/home/matteo/root/macros/ProgettoBazzani/init_data_fixed/init_data_sim500_d4_reds70_fixed.txt");
  while (1) {
    if (!file7.good()) break;
  ...
  ifstream file8("/home/matteo/root/macros/ProgettoBazzani/init_data_fixed/init_data_sim500_d4_reds80_fixed.txt");
  while (1) {
    if (!file8.good()) break;
  ...
  ifstream file9("/home/matteo/root/macros/ProgettoBazzani/init_data_fixed/init_data_sim500_d4_reds90_fixed.txt");
  while (1) {
    if (!file9.good()) break;
  ...
  //tanh1->SetParameters(0.499944,17.3314,-0.500552,0.497912);
  tanh1->SetParameters(0.5,4.77182,-0.500322,0.493559);
...
*/
  ...
  //tanh2->SetParameters(-0.499944,17.3314,-0.500552,0.502088);
  tanh2->SetParameters(-0.5,4.77182,-0.500322,0.506441);
